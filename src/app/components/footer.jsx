...
export default function Footer() {
  return (
    <footer className="bg-black text-white py-6 h-[14vh] md:h-[13.5vh] lg:h-[15vh] fixed bottom-0 left-0 right-0 z-50">
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap justify-center gap-6 mb-6">
          <Link href="https://x.com/BSides_SWFL" className="hover:text-gray-300 text-orange-200" aria-label="Twitter">
            <SiX size={20} />
          </Link>
          <Link href="https://www.facebook.com/people/BSides-SWFL/61566492254339/" className="hover:text-gray-300 text-orange-200" aria-label="Facebook">
            <SiFacebook size={20} />
          </Link>
          <Link href="https://discord.gg/yHfHPZ3JRb" className="hover:text-gray-300 text-orange-200" aria-label="Discord">
            <SiDiscord size={20} />
          </Link>
          ...
          <Link href="/contactus" className="hover:text-gray-300 text-orange-200" aria-label="Contact Us">
            <NotebookPen size={20} />
          </Link>
        </div>
