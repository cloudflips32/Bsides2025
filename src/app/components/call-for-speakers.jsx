...
const CallForSpeakersModal = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white p-4 rounded-lg mx-auto md:max-w-md md:w-1/2 md:h-[75vh] md:items-center md:flex-col items-center justify-center shadow-lg w-full h-3/4 relative">
        <button
          ...
          <div className="bg-white rounded-lg shadow-lg p-6 md:p-8 w-full max-w-2xl">
            ...
            <div className="grid md:grid-cols-2 gap-y-4 md:gap-y-0 md:gap-x-6 mb-6 pb-6 border-b border-gray-200">
              <div>
                ...
                <p className="text-lg font-bold text-gray-800">15 May 2025</p>
              </div>
              <div className="md:text-right">
                <p className="text-gray-600 text-sm mb-1">Call closes at 11:59 PM</p>
                <p className="text-lg font-bold text-gray-800">30 Sep 2025</p>
              </div>
            </div>
            ...
            <div className="mb-8">
              <span className="text-lg font-semibold">Are you passionate about cybersecurity and eager to share your expertise?

                Become a speaker at the 2025 BSides Cybersecurity Conference!
