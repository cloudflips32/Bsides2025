export default function Hero() {
  return (
    <div className="relative wrapper py-16 md:py-32 rounded-xl">
      ...
      <div className="container flex flex-col md:flex-row items-center mx-auto px-4 relative z-10">
        <div className="text-center">
          ...
          <div className="mt-12 flex justify-center">
            <img src="/map.png" alt="Map of the event location" className="w-full h-auto shadow-lg hover:scale-105 transition-transform duration-300" />
          </div>
        </div>
      </div>
    </div>
