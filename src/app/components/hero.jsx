    ...
    return (
      <div className="relative bg-gradient-to-r from-purple-800 via-purple-400 to-blue-500 py-24 md:py-32">
        ...
        <div className="container items-center mx-auto px-4 relative z-10">
          <h1 className="text-4xl text-center md:text-6xl font-bold text-white mb-4">BSides SWFL 2025</h1>
          <p className="text-xl text-center md:text-2xl text-white">November 7-8, 2025</p>
          <div className="text-center flex flex-col md:flex-row md:text-left md:w-1/2">
            ...
            <img src="/map.png" alt="Map of the event location" className="w-full h-auto mt-12 shadow-lg hover:scale-125 transition-transform duration-300" />
          </div>
        </div>
      </div>
    )
