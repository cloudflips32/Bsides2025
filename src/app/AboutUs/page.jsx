...
<ul>
	...
	<li className="bg-gradient-to-tl from-orange-0 via-orange-200 to-orange-300 p-4 flex flex-row justify-between space-x-8 mt-6 border-solid border-1 rounded-xl shadow-sm border-gray-950">
