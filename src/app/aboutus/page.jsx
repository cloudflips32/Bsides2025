...
export default function AboutUs() {
  ...
  return (<> <main className="max-w-5xl mx-auto my-6 p-4">
    ...
    <div className="hidden wrapper md:block relative  md:py-30">
      ...
      <ul>
        <li className="bg-gradient-to-tl from-orange-50 via-purple-200 to-orange-300 p-4 flex flex-row justify-between space-x-8 border-solid border-1 rounded-xl shadow-sm border-gray-950">
